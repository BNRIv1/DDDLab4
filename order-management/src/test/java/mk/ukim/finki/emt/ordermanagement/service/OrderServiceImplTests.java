...
public class OrderServiceImplTests {
    ...
    public void testPlaceOrder() {
        ...
        oi1.setProduct(newProduct("Gigabyte i5 6500, GTX 1060",Money.valueOf(Currency.MKD,60000)));
        oi1.setQuantity(1);

        OrderItemForm oi2 = new OrderItemForm();
        oi2.setProduct(newProduct("Asus TUF F15",Money.valueOf(Currency.MKD,50000)));
        oi2.setQuantity(2);
        ...
        Assertions.assertEquals(newOrder.total(),Money.valueOf(Currency.MKD,160000));
